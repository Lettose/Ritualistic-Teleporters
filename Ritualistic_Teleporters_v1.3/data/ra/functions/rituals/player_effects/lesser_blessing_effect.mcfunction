...
execute as @s[scores={ra.blessing_tick=1}] run attribute @s generic.max_health base set 24
execute as @s[scores={ra.blessing_tick=1}] run attribute @s generic.armor base set 2
...
execute as @s[scores={ra.blessing_tick=36001..}] run tag @s remove lesser_blessing
