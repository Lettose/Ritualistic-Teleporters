...
execute as @s[scores={ra.tick=1}] run attribute @s minecraft:generic.gravity base set 0
execute as @s[scores={ra.tick=1}] run effect give @s blindness 4 255 true

execute as @s[scores={ra.tick=1}] run summon firework_rocket ~ ~ ~ {Silent:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"small_ball",colors:[I;1973019],fade_colors:[I;16777215]}]}}}}
...
execute as @s[scores={ra.tick=3..9}] at @s run particle block{block_state:{Name:deepslate_tiles}} ~ ~1.6 ~ 0.2 0.05 0.2 0 2 force @a
execute as @s[scores={ra.tick=10..34}] at @s run particle block{block_state:{Name:deepslate_tiles}} ~ ~1.2 ~ 0.2 0.05 0.2 0 2 force @a
execute as @s[scores={ra.tick=25..39}] at @s run particle block{block_state:{Name:deepslate_tiles}} ~ ~0.8 ~ 0.2 0.05 0.2 0 2 force @a
execute as @s[scores={ra.tick=40..55}] at @s run particle block{block_state:{Name:deepslate_tiles}} ~ ~0.4 ~ 0.2 0.05 0.2 0 2 force @a
...
execute as @s[scores={ra.tick=55}] run attribute @s minecraft:generic.gravity base set 0.08
