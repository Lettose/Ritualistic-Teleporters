...
execute as @s unless entity @e[tag=cyan2,distance=1..] run kill @e[type=item,distance=0..1,nbt={Item:{id:"minecraft:echo_shard",count:1}},limit=1,sort=nearest]
...
execute as @s run kill @e[type=item,distance=0..1,nbt={Item:{id:"minecraft:cyan_dye",count:1}},limit=1,sort=nearest]