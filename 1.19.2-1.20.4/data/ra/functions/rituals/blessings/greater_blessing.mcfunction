...
execute at @s[scores={ra.tick=1..80}] at @e[tag=ritual,distance=0..1] run particle minecraft:falling_dust gold_block ^3 ^0.1 ^3 0.05 0.05 0.05 0 1 force @a
execute at @s[scores={ra.tick=1..80}] at @e[tag=ritual,distance=0..1] run particle minecraft:falling_dust gold_block ^-3 ^0.1 ^-3 0.05 0.05 0.05 0 1 force @a
...
execute as @s[scores={ra.tick=80}] run kill @e[type=item,distance=0..1,nbt={Item:{id:"minecraft:glistering_melon_slice",Count:1b}},limit=1,sort=nearest]
