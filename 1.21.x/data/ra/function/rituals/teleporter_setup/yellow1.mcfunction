...
execute at @s run tag @e[type=marker,distance=0..1,sort=nearest,limit=1] add yellow1
...
execute as @s run kill @e[type=item,distance=0..1,nbt={Item:{id:"minecraft:yellow_dye",count:1}},limit=1,sort=nearest]