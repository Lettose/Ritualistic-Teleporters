...
execute at @s run tag @e[type=minecraft:armor_stand,distance=0..1,sort=nearest,limit=1] add yellow2
...
execute at @s run kill @e[type=armor_stand,tag=yellow2,distance=1..]
