...
execute at @s[scores={ra.tick=1..80}] at @e[tag=ritual,distance=0..1] run particle minecraft:falling_dust{block_state:{Name:red_wool}} ^0.6 ^0.1 ^0.6 0.05 0.05 0.05 0 1 force @a
...
execute as @s[scores={ra.tick=80}] run kill @e[type=item,distance=0..1,nbt={Item:{id:"minecraft:poppy",count:1}},limit=1,sort=nearest]
